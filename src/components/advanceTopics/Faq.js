...
const Faq = () => {
    ...
    <Card title="Game Play + Content" className="card" bordered={false} >
        ...
        <p>4. What happen if a phase ends and my child forgot to participate in time?</p>
        ...
        <p>8. I'm a child's book author. How do I get my book on Story Squad?</p>
    </Card>
  </div>
  <div className="site-card-border-less-wrapper">
    <Card title="Child Profile Management" className="card" bordered={false} >
  ...
  <div className="site-card-border-less-wrapper">
    <Card title="Account Settings" className="card" bordered={false} >
        ...
        <p>2. How do I update my parent email for my Story Squad subscription?</p>
    </Card>
  </div>
  <div className="site-card-border-less-wrapper">
